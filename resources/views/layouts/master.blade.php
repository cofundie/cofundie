        ...
        <div class="container">
            <div class="search-area-inner">
                <div class="search-contents ">
                    <form action="http://themevessel-item.s3-website-us-east-1.amazonaws.com/xero/index.html" method="GET">
                        <div class="row">
                    ...
                    <div class="property-box-7">
                        <div class="property-thumbnail">
                            <a href="properties-details.html" class="property-img">
                                ...
                                <div class="price-box"><span>$850.00</span> Per night</div>
                                <img src="assets/img/property-8.jpg" alt="property-8" class="img-fluid">
                            </a>
                        </div>
                        <div class="detail">
                            <h1 class="title">
